          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 72 }}>
            <div>
              ...
              <p style={{ fontSize: 17, lineHeight: 1.75, color: palette.ink, margin: 0 }}>
                Annual checkups, sick visits, chronic care, and everything in between. We take the time to listen, answer your questions, and build a plan that actually works for your day-to-day. No rushing, no surprises.
              </p>
            </div>
            <div>
